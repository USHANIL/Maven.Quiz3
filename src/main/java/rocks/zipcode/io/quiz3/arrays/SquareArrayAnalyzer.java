...
public class SquareArrayAnalyzer {
    ...
    public static Boolean compare(Integer[] inputArray, Integer[] squaredValues) {
        ...
        //array to store the squared values
        Integer[] calSquares = Arrays.stream(inputArray).map(value -> value*value).toArray(Integer[]::new);

        return Arrays.equals(calSquares, squaredValues);
    }
}
